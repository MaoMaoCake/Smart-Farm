...
<div class=" flex grow w-screen justify-center">
    <a href="/{$page.params.farm_id}/light_preset/{$page.params.preset_id}/light_combination_list?farm_id={$page.params.farm_id}&preset_name={preset_name}&preset_id={$page.params.preset_id}">
      <p class="underline items-center mt-3 underline-offset-2 flex">Preset: {preset_name}</p>
    </a>
   </div>
        ...
        <div class="flex grow flex-col items-center w-full pb-5">
            <div class="flex justify-evenly w-full">
                ...
                <button class="btn bg-gray-300 text-black"
                        on:click={goto(`/${$page.params.farm_id}/light_preset`)}>Preset list
                    ...
                    <div class="absolute left-10 bottom-10">
                        <div class="bg-yellow-200 w-56 h-30 rounded-xl relative z-30">
                            <div class="text-black">
                                <p>This button will apply the current setting to all light in the preset</p>
                            </div>
                        </div>
                    </div>
                {/if}
