<script lang="js">
  ...
  fetch(`/api/users/verify/${$page.params.verification_code}`, {
    ...
    .then(async response => verify_handler(await response.json()))
    .catch(error => console.log('error', error));

   function verify_handler(response) {
              ...
              <img src="https://cdn.discordapp.com/attachments/802176047096922175/1091638749827444736/logo.png" alt="Logo" class="w-24 h-24">
                <div class="card-body">
                  ...
                  <div class="form-control">
                    ...
                    <input type="email" placeholder="email" class="input input-bordered" bind:value={email} disabled={true}/>
                    {#if errors.email}
